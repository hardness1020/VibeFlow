...
This skill helps users go from a vague idea to a concrete work item registration. It runs **before** `/vibeflow-orchestrator register` to ensure the right track, scope, and description are chosen.
